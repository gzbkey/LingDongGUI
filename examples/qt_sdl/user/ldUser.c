...
void userInit(void)
{
    ...
    img0=ldImageInit(1, 0, 20,20,72,72,(uint32_t)&release_png[0],true);
    ...
    ldButtonSetImage(btn0,(uint32_t)&release_png[0],true,(uint32_t)&press_bmp[0],false);

    ldButtonSetSelectImage(btn0,(uint32_t)&frame_png[0],__RGB(255,0,0));
