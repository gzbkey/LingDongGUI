...
/* ARM::Acceleration:Arm-2D Extras:Controls@1.6.2 */
...
/* ARM::Acceleration:Arm-2D Helper:Display Adapter@2.3.0 */
...
/* ARM::Acceleration:Arm-2D Helper:PFB@1.10.8 */
...
/* ARM::Acceleration:Arm-2D:Core@1.1.6 */
