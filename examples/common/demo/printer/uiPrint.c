...
arm_2d_tile_t *imgList[8]={IMAGE_ALARMCLOCK_S_PNG,IMAGE_BLOCKRABBIT_S_PNG,IMAGE_CAKE_S_PNG,IMAGE_DOLL_S_PNG,IMAGE_MILK_S_PNG,IMAGE_MUG_S_PNG,IMAGE_SMALLROOM_S_PNG};
...
uint8_t *pListName[]={"闹钟","方块兔","巧克力蛋糕","福娃","奶牛盒","马克杯","小房间"};
void uiPrintInit(ld_scene_t* ptScene)
{
    void *obj,*win;
    ...
    obj=ldButtonInit(ID_BTN_RET,ID_BG,50,0,80,50);
    ldButtonSetFont(obj,FONT_SIMSUN_18);
    ldButtonSetText(obj,"首页");
    ...
    obj=ldImageInit(ID_IMG,ID_BG,280,50,176,160,imgList[0],NULL,false);
