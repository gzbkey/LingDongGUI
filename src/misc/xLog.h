...
#define LOG_ERROR(fmt, ...)             LOG_PRINT(ANSI_RED"[E] " ANSI_RESET fmt "\r\n",##__VA_ARGS__)
#define LOG_NORMAL(fmt, ...)             LOG_PRINT(ANSI_RESET fmt "\r\n",##__VA_ARGS__)
#else
#define LOG_ERROR(...)                  {}
#define LOG_NORMAL(...)                  {}
#endif
#if (USE_LOG_LEVEL>=LOG_LEVEL_WARNING)
#define LOG_WARNING(fmt, ...)           LOG_PRINT(ANSI_YELLOW"[W] " ANSI_RESET fmt "\r\n",##__VA_ARGS__)
#else
#define LOG_WARNING(...)                {}
#endif
#if (USE_LOG_LEVEL>=LOG_LEVEL_INFO)
#define LOG_INFO(fmt, ...)              LOG_PRINT(ANSI_GREEN"[I] " ANSI_RESET fmt "\r\n",##__VA_ARGS__)
#else
#define LOG_INFO(...)                   {}
#endif
#if (USE_LOG_LEVEL>=LOG_LEVEL_DEBUG)
#define LOG_DEBUG(fmt, ...)             LOG_PRINT(ANSI_BLUE"[D] " ANSI_RESET fmt "\r\n",##__VA_ARGS__)
